...
public class Initialization {
    ...
    public void readInput() throws IOException {
        ...
        ClassRoom room1 = new ClassRoom("ED15", 20, false, "Common", 70);
        classroom.add(room1);
        ClassRoom room2 = new ClassRoom("ED14", 20, false, "ComputerScience", 100);
        classroom.add(room2);
        ClassRoom room3 = new ClassRoom("LAB 3", 20, true, "ComputerScience", 90);
        classroom.add(room3);
        ClassRoom room4 = new ClassRoom("LAB 2", 20, true, "Computer Science", 60);
        classroom.add(room4);
	ClassRoom room5 = new ClassRoom("SS1", 20, false, "Fedcos", 80);
	classroom.add(room5);
...
//		classroom.add(room6);
        ...
        professors.add(new Professor(1, "Katiku", "COMP222/COMP412/COMP378"));
